...
- Phase 5.6 (in progress): Historical Data Warehouse — planning card `t_90ca9e6f` Done. 4 implementation cards Done (`t_1c8a70da` — MarketDataProvider interface, commit `808ec02`; `t_b2a75ee8` — Local historical warehouse layout, commit `c2173c9`; `t_56f319a9` — Data catalog extension, commit `0fd96dd`; `t_6168af8e` — Parquet bar storage, commit `e287c50`). 8 remaining implementation cards Ready. Downstream fully unblocked: `t_e9626fc3` (duckdb_queries), `t_c32b8416` (data_versioning), `t_ababb2f7` (validation), `t_22210825` (provider_plugins). Non-blocking for v1.0. Storage architecture: DuckDB + Parquet + SQLite (hybrid). Design doc: `docs/architecture/phase-5-6-historical-warehouse.md`.
